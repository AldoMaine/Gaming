...
btn_import.config(bg="lemon chiffon", fg="black")

btn_export = tk.Button(frame2, text="   Export   ", command=export)
btn_export.grid(row=1, column=2, sticky='ew', padx=10, pady=5)
btn_export.config(bg="sky blue", fg="black")

btn_clear = tk.Button(frame2, text="   Clear   ", command=clear_compare)
btn_clear.grid(row=1, column=3, sticky='ew', padx=10, pady=5)
